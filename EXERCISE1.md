...
| Classes        | Methods                 | Scenario                | Outputs          |
|----------------|-------------------------|-------------------------|------------------|
| `ShoppingCart` | `sum(List<Item> items)` | Sums prices of items    | `double totalCost` |
|
...
| Classes    | Methods                                              | Scenario                                                                                              | Outputs                   |
|------------|------------------------------------------------------|-------------------------------------------------------------------------------------------------------|---------------------------|
| `Expenses` | `shoppingHistory(List<Item> items)` | Returns list of strings from list `items` and their prices. Returns total cost of products in basket. | `String[] listOfExpenses` |
|
